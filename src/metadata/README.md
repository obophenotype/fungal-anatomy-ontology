 ...
 * [fao.yml](fao.yml)
     * Determines how your purl.obolibrary.org/obo/fao/ redirects will be handled
     ...
     * Paste in the contents of [fao.yml](fao.yml)
 ...
 * [fao.md](fao.md)
     ...
     * Paste in the contents of [fao.md](fao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
