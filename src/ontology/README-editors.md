These notes are for the EDITORS of fao
...
Make sure you have an ID range in the [idranges file](fao-idranges.owl)
 ...
 * [fao-idranges.owl](fao-idranges.owl)
 ...
 * https://github.com/obophenotype/fungal-anatomy-ontology/releases
 * https://github.com/obophenotype/fungal-anatomy-ontology/releases/new
...
what is in the versionIRI of the derived fao.owl (data-version in
fao.obo).
 ...
 * http://purl.obolibrary.org/obo/fao.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/fao/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/fungal-anatomy-ontology.svg?branch=master)](https://travis-ci.org/obophenotype/fungal-anatomy-ontology)
